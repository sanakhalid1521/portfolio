...
const About = () => {
    return (
      <section id="about" className="p-8 font-normal justify  justify-center bg-gradient-to-r from-black to-gray-800 text-gray-200">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-center">About Me</h2>
          <p>I am Sana Khalid, a passionate and dedicated web developer with a strong focus on crafting visually appealing, user-friendly, and responsive web applications. My journey in web development is driven by a deep appreciation for both the technical and creative sides of the field, allowing me to bring unique ideas to life through clean, modern code and intuitive design.
